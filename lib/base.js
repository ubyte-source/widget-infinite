    ...
    class Infinite {
        ...
        constructor() {
            ...
            this.elements = {
                ...
                // body: Body
                // notice: Notice
                // setting: window.Infinite.Plugin.Setting
            };
        ...
        request(everywhere) {
            ...
            if (offset === 0) {
                ...
                for (let item in tr) {
                    ...
                    if (checkbox instanceof window.Infinite.Body.Checkbox && checkbox.getInput().checked === true) continue;
        ...
        result() {
            ...
            if (typeof everywhere === 'function') everywhere.call(this, response);
            ...
            if (response.status === false || !response.hasOwnProperty(key)) {
                ...
                if (typeof fail === 'function') fail.call(this, response);
            ...
            if ((response.hasOwnProperty(this.constructor.complete()) && response[this.constructor.complete()] === false) && true === scroller
                || (0 !== response[key].length && true === scroller)) return this.request(everywhere);
