    ...
    class Infinite {
        ...
        result() {
            ...
            if (response[key].length === 0) {
                let tr = this.getBody().getTR(), count = Object.keys(tr);
                if (count.length === 0) {
            ...
            if (response[key].length - count === 0 && container.scrollHeight - container.offsetHeight - container.scrollTop <= 0) return this.request();
